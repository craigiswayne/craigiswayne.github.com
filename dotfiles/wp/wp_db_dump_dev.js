 ...
 */
const wpIsInstalled = sh.exec( 'wp core is-installed' );
if ( 0 !== wpIsInstalled.code ) {
...
// mysqldump -u$DEV_MYSQL_USERNAME -p$DEV_MYSQL_PASSWORD -h$DEV_MYSQL_HOST $db_name --verbose
// > $(wp eval "echo ABSPATH;")$db_filename;
